...
[mean_z_ER,mean_z2_ER,upp_bound_ER] = Algorithm1(T,s,G_ER2,a_star_ER,H_ER,test_no,sigma,N,b);

[mean_z_SF,mean_z2_SF,upp_bound_SF] = Algorithm1(T,s,G_ER2,a_star_SF,H_SF,test_no,sigma,N,b);

[mean_z_Com,mean_z2_Com,upp_bound_Com] = Algorithm1(T,s,G_ER2,a_star_Com,H_Com,test_no,sigma,N,b);
